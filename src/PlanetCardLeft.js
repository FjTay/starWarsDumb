      ...
      {planetData[planet].globalWeather && (
        <>
          ...
          <div className="weatherName">
            <p>
              {!planetData[planet].globalWeather.daily.weathercode[currentDay] ? "SUNNY" : Weathername(
                planetData[planet].globalWeather.daily.weathercode[currentDay]
              )}
            </p>
          </div>
          <div className="weather-spec-icon">
          {["rain", "windDirection", "wind", "sunrise", "sunset"].map(icon => 
            <img src={weatherIcon(icon, "static-icons")} alt={icon} />
          )}
          </div>
